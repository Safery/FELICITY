                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="../images/logo.png" alt="CoolAdmin" style="width:160px;height:120px;">
                            </a>
                        </div>
                        <div class="login-form">
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                                    ...
                                    <input class="au-input au-input--full" type="text" name="username" value="<?php echo $username; ?>" placeholder="Username">
                            ...
                            <div class="register-link">
                                <p>
                                    ...
                                    <a href="../loginFeature/login.php">Sign In</a>
                                </p>
                            </div>
                        </div>
                    </div>
